...
-->
    ...
    <link rel="stylesheet" type="text/css" href="assetsnew/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="assetsnew/css/font-awesome.css">

    <link rel="stylesheet" href="assetsnew/css/templatemo-breezed.css">

    <link rel="stylesheet" href="assetsnew/css/owl-carousel.css">

    <link rel="stylesheet" href="assetsnew/css/lightbox.css">
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <img src="\assetsnew\images\a.png"  style="height: 100px;
  width: 100px">
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assetsnew/images/slide-01.jpg" alt="">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assetsnew/images/slide-02.jpg" alt="">
                <div class="text-content">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assetsnew/images/slide-03.jpg" alt="">
                <div class="text-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="assetsnew/images/service-item-01.png" alt="">
                                    <h4>Performance</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="assetsnew/images/contact-info-03.png" alt="">
                                    <h4>Reliable</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
...
<body>
	...
	<div class="containera">
		...
		<div class="rowa">
			<div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
					<img src="assetsnew\images\project-item-05.jpg" >
				</div>
			</div>

			<div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
					<img src="assetsnew/images/project-item-06 (3).jpg" >
				</div>
			</div>
			...
			<!-- <div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
                <img src="assetsnew/images/project-item-04.jpg" >
				</div> -->
			<!-- </div><div class="col-lg-4 col-sm-12">
				<div class="thumbnail">
                <img src="assetsnew/images/project-item-03.jpg" >
				</div>
			</div> -->
			<!-- <div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <ul class="contact-info">
                            <li><img src="assetsnew/images/contact-info-01.png" alt="">0112111497</li>
                            <li><img src="assetsnew/images/contact-info-02.png" alt="">info@company.com</li>
                            <li><img src="assetsnew/images/contact-info-03.png" alt="">www.company.com</li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="assetsnew/js/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="assetsnew/js/popper.js"></script>
    <script src="assetsnew/js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="assetsnew/js/owl-carousel.js"></script>
    <script src="assetsnew/js/scrollreveal.min.js"></script>
    <script src="assetsnew/js/waypoints.min.js"></script>
    <script src="assetsnew/js/jquery.counterup.min.js"></script>
    <script src="assetsnew/js/imgfix.min.js"></script>
    <script src="assetsnew/js/slick.js"></script>
    <script src="assetsnew/js/lightbox.js"></script>
    <script src="assetsnew/js/isotope.js"></script>
