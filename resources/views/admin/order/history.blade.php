<x-admin-layout>
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <aside id="sidebar"
            ...
            aria-label="Sidebar">
            <div
                class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white bads-r bads-gray-200 dark:bg-gray-800 dark:bads-gray-700">
                                ...
                                <form action="#" method="GET" class="lg:hidden">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="email" id="mobile-search"
                                            class="bg-gray-50 bads bads-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:bads-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:bads-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:bads-primary-500"
                                            placeholder="Search">
                                    </div>
                                </form>
                            </li>
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
            <main>
                <div
                    class="p-4 bg-white block sm:flex items-center justify-between bads-b bads-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:bads-gray-700">
                                ...
                                <form class="sm:pr-3" action="#" method="GET">
                                    ...
                                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                                        <input type="text" name="email" id="products-search"
                                            class="bg-gray-50 bads bads-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:bads-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:bads-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:bads-primary-500"
                                            ...
                                            <th scope="col" class="p-4">
                                                <div class="flex items-center">
                                                    <input id="checkbox-all" aria-describedby="checkbox-1"
                                                        type="checkbox"
                                                        class="w-4 h-4 bads-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:bads-gray-600">
                                    ...
                                    <tbody
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td
                                                    ...
                                                    {{ $ads->tot }}</td>
                                                    <td
                                                    class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white" style="color: red">
                                                    {{ $ads->status == '0' ?'Pending' : 'delivered' }}</td>

                                                    <td class="py-4 pl-4 pr-3 text-sm font-medium">
                                                        <div class="flex gap-3">
                                                            <a href="{{ url('orderadmion/' . $ads->id) }}"
                                                                class="rounded-md bg-red-400 px-4 py-2 text-sm font-semibold text-white hover:bg-green-600 transition-all duration-300" style="background-color: green">View</a>
                ...
                <div
                    class="sticky bottom-0 right-0 items-center w-full p-4 bg-white bads-t bads-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:bads-gray-700">
